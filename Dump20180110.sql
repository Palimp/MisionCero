...
INSERT INTO `videos` (`id`, `url`, `texto`, `solucion`) VALUES
(1, 'https://www.youtube.com/embed/0PfbrsVexsE?&rel=0&showinfo=0&end=30', 'Los Exploradores deberán contar las cartas rojas que va a mostrar el protagonista de nuestro vídeo (el audio no es importante <i class=\"fa fa-smile-o\"></i>)', 'Algunas cartas tienen en el dorso un gorila, un gatito, un cachorro, un hombre o una mujer. Es increíble lo que uno puede perderse teniéndolo justo delante! \n<i class=\"fa fa-smile-o\"></i>\n\nGanará 2 bikles el equipo que haya detectado algún elemento diferente en el dorso de las cartas\n\nGanará 4 bikles el equipo capaz de enumerar alguno de los elementos que aparecen'),
(2, 'https://www.youtube.com/embed/14Nb45CS9og?&rel=0&showinfo=0&end=50', 'Los Exploradores deberán observar con atención el siguiente truco de magia (el audio no es importante <i class=\"fa fa-smile-o\"></i>)', 'Mientras Apollo Robbins hacía el truco de magia casi todos los elementos de la escena han cambiado! <i class=\"fa fa-smile-o\"></i>\nGanará 2 bikles el equipo capaz de enumerar 1 elemento que ha cambiado \nGanará 4 bikles el equipo capaz de enumerar más de 1 elemento que ha cambiado'),
(3, 'https://www.youtube.com/embed/_aSXE_xppME?&rel=0&showinfo=0&end=53', 'Los Exploradores deberán observar con atención el siguiente video', 'Mientras nuestro inspector interrogaba a los personajes, casi todos los elementos de la escena han cambiado! <i class=\"fa fa-smile-o\"></i> \nGanará 2 bikles el equipo que haya detectado que algo del decorado ha cambiado \nGanará 4 bikles el equipo capaz de enumerar elementos que han cambiado'),
(4, 'https://www.youtube.com/embed/hWqWL9SH09o?&rel=0&showinfo=0&end=26', 'Los Exploradores deberán contar los pases que realiza el equipo blanco', 'Mientras se pasaban la pelota, un oso se ha marcado el baile moonwalking justo en el centro! <i class=\"fa fa-smile-o\"></i>\nGanará 2 bikles el equipo que haya detectado algún elemento diferente a los jugadores en la escena\nGanará 4 bikles el equipo capaz de describir al oso y a su baile moonwalking'),
(5, 'https://www.youtube.com/embed/kd2dQ26DdFQ?&rel=0&showinfo=0&end=22', 'Los Exploradores deberán contar los pases que realiza el equipo blanco', 'Mientras se pasaban la pelota, una cheerleader ha pasado por detrás haciendo acrobacias! <i class=\"fa fa-smile-o\"></i>\nGanará 2 bikles el equipo que haya detectado algún elemento diferente a los jugadores en la escena\nGanará 4 bikles el equipo capaz de describir a la cheerleader y sus acrobacias'),
(6, 'https://www.youtube.com/embed/ULDusoZbzdY?&rel=0&showinfo=0&end=28', 'Los Exploradores deberán observar con atención el siguiente video (el audio no es importante <i class=\"fa fa-smile-o\"></i>)', 'La persona que atiende en el mostrador no es la misma al principio y al final de la escena <i class=\"fa fa-smile-o\"></i>!\nGanará 2 bikles el equipo que haya detectado que algo del decorado ha cambiado \nGanará 4 bikles el equipo que haya detectado que el vendedor ha cambiado'),
(7, 'https://www.youtube.com/embed/QgZVLMjhvMQ?&rel=0&showinfo=0&end=70', 'Los Exploradores deberán observar con atención el siguiente truco de magia (el audio no es importante <i class=\"fa fa-smile-o\"></i>)', 'Mientras Apollo Robbins hacía el truco de magia han pasado por detrás un conejo, un oso y un gorila!! <i class=\"fa fa-smile-o\"></i>\nGanará 2 bikles el equipo que haya detectado algunos personajes extraños en la escena \nGanará 4 bikles el equipo capaz de enumerar algunos de estos personajes'),
(8, 'https://www.youtube.com/embed/qpPYdMs97eE?&rel=0&showinfo=0&end=40', 'Los Exploradores deberán observar con atención el siguiente video (el audio no es importante <i class=\"fa fa-smile-o\"></i>)', 'La calle entera ha cambiado completamente! <i class=\"fa fa-smile-o\"></i> \nGanará 2 bikles el equipo que haya detectado que algo en la calle ha cambiado \nGanará 4 bikles el equipo capaz de enumerar elementos que han cambiado');
