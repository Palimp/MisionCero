    ...
    <section class="container text-center">
        <div>
            <p class="title_first pb-4">
               <?=__('Ranking de Bikles al acabar la etapa 7')?>
            </p>
        </div>
        <?php if ($admin) { ?>
            <p>
                <?=__('¡El Jefe de Expedición distribuye los Bikles ganados o perdidos por los equipos!')?>
            </p>
            <p class="green">
                        ...
                        <td>
                            ...
                            if ($admin) {
                                echo $this->Form->create('Begin', array(
                                    'url' => array('controller' => 'Game', 'action' => 'page50'), 'class' => 'd-inline-block'
                                ));
                                ?>
    ...
    <?php } ?>
      ...
      <?php if ($admin) { ?>
          <div class="my-4 text-right">
              ...
              <button  id="siguiente" type="button" class="btn btn-primary"><?= __('Ir a Etapa 8') ?></button>
          </div>
      <?php } ?>
    </section>
</main>
