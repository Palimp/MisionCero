...
<script>
    ...
    var page = 44;
    var stop = 1;
    var inter = '<tr><td scope="row" class="align-top"></td><td></td><td></td></tr>';
            ...
            $('#addinter').click(function () {
                ...
                $.get("<?= $this->Url->build(["controller" => "Game", "action" => "addinter"]) ?>",
                    ...
                    if (status == 'success') {
                        ...
                        $('#addinter').closest('tr').before('<tr id="bloque' + data + '"><td> <span class="painc">' + $('#inter').val() + '</span></td><td>' + pain + '</td><td></td></tr>');
                        ...
                        $('#addpain_' + data).click(function () {
                            ...
                            $.get("<?= $this->Url->build(["controller" => "Game", "action" => "addpain"]) ?>",
                                ...
                                if (status == 'success') {
                                    console.log(data)
                                    $('#addpain_' + id).closest('tr').before('<tr id="pain' + id + '"><td> <span class="painc">' + $('#addpain_' + id).closest('tr').find("td:first").find("span").html() + '</span></td><td>' + $('#pain_' + id).val() + '</td><td>' + ppcha + '</td></tr>');
